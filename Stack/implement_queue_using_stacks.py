...
# Some knowleghe about implementing this:

# List()
#     append() -- adding the element to the end 
#     pop() --  without index, then delete the last element; if given the index, delete that specific element
